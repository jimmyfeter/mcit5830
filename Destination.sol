...
function createToken(
    ...
    // Deploy new BridgeToken contract with the expected parameters
    BridgeToken newToken = new BridgeToken(name, symbol, 0, address(this)); // Assuming 0 initial supply and this contract as owner
